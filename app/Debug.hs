...
opcodeNames = M.fromList
    ...
    (0x01, "Indirectx ORA"),
    (0x05, "Zeropage ORA"),    (0x08, "Implied PHP"),    (0x09, "Immediate ORA"),
    (0x0D, "Absolute ORA"),    (0x10, "Relative BPL"),    (0x11, "Indirecty ORA"),
    (0x15, "Zeropagex ORA"),    (0x18, "Implied CLC"),    (0x19, "Absolutey ORA"),
    (0x1D, "Absolutex ORA"),    (0x20, "Absolute JSR"),    (0x21, "Indirectx AND"),
    (0x25, "Zeropage AND"),    (0x26, "Zeropage ROL"),    (0x28, "Implied PLP"),
    (0x29, "Immediate AND"),    (0x2A, "Implied ROL"),    (0x2D, "Absolute AND"),
    (0x2E, "Absolute ROL"),    (0x30, "Relative BMI"),    (0x31, "Indirecty AND"),
    (0x35, "Zeropagex AND"),    (0x36, "Zeropagex ROL"),    (0x38, "Implied SEC"),
    (0x39, "Absolutey AND"),    (0x40, "Implied RTI"),    (0x3D, "Absolutex AND"),
    (0x3E, "Absolutex ROL"),    (0x41, "Indirectx EOR"),    (0x45, "Zeropage EOR"),
    (0x48, "Implied PHA"),    (0x49, "Immediate EOR"),    (0x4C, "Absolute JMP"),
    (0x4D, "Absolute EOR"),    (0x50, "Relative BVC"),    (0x51, "Indirecty EOR"),
    (0x55, "Zeropagex EOR"),    (0x58, "Implied CLI"),    (0x59, "Absolutey EOR"),
    (0x5D, "Absolutex EOR"),    (0x60, "Implied RTS"),    (0x61, "Indirectx ADC"),
    (0x65, "Zeropage ADC"),    (0x66, "Zeropage ROR"),    (0x68, "Implied PLA"),
    (0x69, "Immediate ADC"),    (0x6A, "Implied ROR"),    (0x6C, "Indirect JMP"),
