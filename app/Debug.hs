...
getMnemonic opcode = M.findWithDefault ("Unknown opcode: " ++ showHexF opcode) opcode opcodeNames
...
opcodeNames = M.fromList
    ...
    (0x09, "Immediate ORA"),    (0x0A, "Implied ASL"),    (0x0D, "Absolute ORA"),
    ...
    (0x20, "Absolute JSR"),    (0x21, "Indirectx AND"),    (0x25, "Zeropage AND"),
    (0x26, "Zeropage ROL"),    (0x28, "Implied PLP"),    (0x29, "Immediate AND"),
    ...
    (0x3D, "Absolutex AND"),    (0x3E, "Absolutex ROL"),    (0x40, "Implied RTI"),
    (0x41, "Indirectx EOR"),    (0x45, "Zeropage EOR"),    (0x46, "Zeropage LSR"),
    (0x48, "Implied PHA"),    (0x49, "Immediate EOR"),    (0x4A, "Implied LSR"),
    (0x4C, "Absolute JMP"),    (0x4D, "Absolute EOR"),    (0x4E, "Absolute LSR"),
    (0x50, "Relative BVC"),    (0x51, "Indirecty EOR"),    (0x55, "Zeropagex EOR"),
    (0x56, "Zeropagex LSR"),    (0x58, "Implied CLI"),    (0x59, "Absolutey EOR"),
    (0x5D, "Absolutex EOR"),    (0x5E, "Absolutex LSR"),    (0x60, "Implied RTS"),
    (0x61, "Indirectx ADC"),    (0x65, "Zeropage ADC"),    (0x66, "Zeropage ROR"),
    (0x68, "Implied PLA"),    (0x69, "Immediate ADC"),    (0x6A, "Implied ROR"),
    ...
    (0xD6, "Zeropagex DEC"),    (0xD8, "Implied CLD"),    (0xD9, "Absolutey CMP"),
